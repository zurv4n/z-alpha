...
convar_category 'PMA-Voice' {
	...
	{ "Use 3D audio", "$voice_use3dAudio", "CV_BOOL", "true" },
	{ "Use sending range only", "$voice_useSendingRangeOnly", "CV_BOOL", "true" },
	{ "Enable UI", "$voice_enableUi", "CV_INT", "0" },
	{ "Enable J proximity key", "$voice_enableProximityCycle", "CV_INT", "1" },
	{ "Proximity cycle key", "$voice_defaultCycle", "CV_STRING", "J" },
