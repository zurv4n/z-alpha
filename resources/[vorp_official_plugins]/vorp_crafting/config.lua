...
Config.Crafting = {
    {
        ...
        Job = {'later'}, -- set to 0 to allow any jobs, or like { "butcher" } to job restriction
    ...
    }, 
	{
        ...
        Type = "item", -- indicate if it is 'weapon' or 'item'
        Job = "OML", -- set to 0 to allow any jobs, or like { "butcher" } to job restriction
        Location = 0, -- set to 0 to allow any locations from Config.Locations, or like { "butcher" } to job restriction
        UseCurrencyMode = false,
        CurrencyType = 0, -- 0 = money, 1 = gold
        Category = "food",
	...
	{
        Text = "Plain Stringy Meat",
        SubText = "InvMax = 1",
        Desc = "Recipe 1x Stringy Meat",
        Items = {
            {
                name = "stringy",
                count = 1
	...
	{
        Text = "Plain Game Meat",
        SubText = "InvMax = 1",
        Desc = "Recipe 1x Game Meat",
        Items = {
            {
                name = "game",
                count = 1
	...
	{
        Text = "Plain Bird Meat",
        SubText = "InvMax = 1",
        Desc = "Recipe 1x Bird Meat",
        Items = {
            {
                name = "bird",
                count = 1
