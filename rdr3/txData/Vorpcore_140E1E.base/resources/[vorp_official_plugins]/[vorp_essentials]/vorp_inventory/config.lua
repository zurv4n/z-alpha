...
Config = {
  ...
  -- FIRST JOIN
  startItems = {
    plain_game_cooked = 3, --ITEMS SAME NAME AS IN DATABASE
    water = 5         --AMMO SAME NAME AS I NTHE DATABASE
  },
  startWeapons = {
  ...
  Ammolabels = {
    ...
    AMMO_REPEATER = "Regular Repeater",
    ...
    AMMO_REVOLVER = "Regular Revolver",
