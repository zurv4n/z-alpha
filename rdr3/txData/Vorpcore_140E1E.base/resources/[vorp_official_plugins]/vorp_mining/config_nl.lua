...
---------------------------
Config.Items = {
    {name = "clay", label = "Klei", chance = 8, amount = 4},
    {name = "coal", label = "Houtskool", chance = 8, amount = 4},
    {name = "copper", label = "Koper", chance = 6, amount = 8},
    {name = "iron", label = "Ijzer", chance = 6, amount = 12},
    {name = "nitrite", label = "Nitriet", chance = 8, amount = 4},
    {name = "rock", label = "Steen", chance = 10, amount = 4},
    {name = "salt", label = "Zout", chance = 10, amount = 4},
    {name = "goldnugget", label = "Goudklomp", chance = 3, amount = 2},
}
