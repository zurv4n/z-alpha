...
Config.AnimalTrackingJobOnly = true -- If true only people with the jobs below can use the tracking option
...
Config.XpPerFeed = 100 -- The amount of XP every feed gives
Config.NotifyWhenHungry = true -- Puts up a little notification letting you know your pet can be fed. 
Config.AnimalFood = 'Feed_For_Dog' -- The item required to feed and/or level up your pet
...
Config.Keys = { ['G'] = 0x760A9C6F, ["I"] = 0xC1989F95, ['S'] = 0xD27782E3, ['W'] = 0x8FD015D8, ['H'] = 0x24978A28, ['U'] = 0xD8F73058, ["R"] = 0x0D55A0F0, ["ENTER"] = 0xC7B5340A, ['E'] = 0xDFF812F9, ["J"] = 0xF3830D8E }
